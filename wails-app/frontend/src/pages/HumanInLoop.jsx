...
import { CheckCircle, XCircle, Clock, RefreshCw, ChevronDown, ChevronRight, AlertTriangle } from 'lucide-react'
    ...
    <div style={{ padding: '24px 28px', maxWidth: 760 }}>
      ...
      {!loading && items.length === 0 && !error && (
        <div style={{
          ...
          <div style={{ fontSize: 13 }}>Workflows with a Human in Loop node will appear here when they need approval.</div>
        </div>
      )}
